...
class SellerProfile (models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE,verbose_name="Do'kon egasi")
    ...
    created_at = models.DateTimeField(auto_now_add=False,verbose_name="yaratilgan vaqti")
    updated_at = models.DateTimeField(auto_now=False,verbose_name="yangilangan vaqti")